...
public class MSTTest {
    ...
    @Test(timeout = 500)
    public void smallishTest() { check(20, 10, 100, 19234, 1076); }

    @Test(timeout = 500)
    public void biggishTest1() { check(5000, 30000, 1000, 192345, 536912); }
    ...
    @Test(timeout = 2000)
    public void biggishTest3() { check(200000, 1000000, 100, 192345678, 2515034, BIG3);
    }
